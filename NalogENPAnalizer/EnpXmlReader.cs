...
namespace NalogENPAnalizer
{
    public class EnpXmlReaderToDb
    {
        ...
        public void ReadXmlToDb(string filePath)
        {
            ...
            KppData zeroKpp = new KppData() { Kpp = "000000000" };
            KbkData zerokbk = new KbkData() { KodKbk = "00000000000000000000", Name = "Остаток" };
            DocOsnData zeroOsn = new DocOsnData() { Name = "Остаток на начало периода" };
            OktmoData zeroOktmo = new OktmoData() { Oktmo = "00000000" };
            PokazatelData zeroPokazatel = new PokazatelData() { Name = "Остаток на начало периода" };
            kbk.Add(zerokbk.KodKbk, zerokbk);
            kpp.Add(zeroKpp.Kpp, zeroKpp);
            osn.Add(zeroOsn.Name, zeroOsn);
            oktmo.Add(zeroOktmo.Oktmo, zeroOktmo);
            pokazatel.Add(zeroPokazatel.Name, zeroPokazatel);
            zeroOp.Summa = saldo;
            zeroOp.Kpp = zeroKpp;
